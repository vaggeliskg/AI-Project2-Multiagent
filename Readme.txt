...
betterEvaluationFunction: Παρόμοια και με το πρώτο ερώτημα τα βάρη της συνάρτησης αυτής προέκυψαν μετά από δοκιμές που βασίστηκαν
πάνω στο q1. Η διαφορά τώρα είναι ότι πλέον ο pacman χρησιμοποιεί manhattan distances για να βρει την απόσταση 
στο πιο κοντινό φαγητό και στο πιο κοντινό φάντασμα και στο τέλος ενημερώνει το σκορ που βασίζεται στα αποτελέσματα
των παραπάνω αποστάσεων. Τέλος προστίθεται και το successorGameState.getScore() που βελτιώνει περαιτέρω τα αποτελέσματα
της συνάρτησης κάνοντας την να λειτουργεί αποτελεσματικά και σχετικά γρήγορα.